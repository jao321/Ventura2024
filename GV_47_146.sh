...
#SBATCH --output=/vols/opig/users/gervasio/rep_pipe_GV146_log.out
#SBATCH --error=/vols/opig/users/gervasio/rep_pipe_GV146_oops_did_not_work.out
...
# dir="/vols/opig/users/gervasio/covidao/sagarana/GV/GV146"
...
# python3 /vols/opig/users/gervasio/covidao/local_usr/MaskPrimers.py align -s "$dir"/"$sample"_quality-pass.fastq -p /vols/opig/users/gervasio/covidao/primers_seq.fasta --outdir "$dir" --outname "$sample" --mode tag --fasta --log "$sample"_primer.log --failed
