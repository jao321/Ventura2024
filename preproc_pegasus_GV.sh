...
#SBATCH -w garganey.stats.ox.ac.uk
#SBATCH --output=/vols/opig/users/gervasio/GV_changeo.out
#SBATCH --error=/vols/opig/users/gervasio/GV_changeo.err


source /vols/opig/users/gervasio/local/bin/activate

dir="/vols/opig/users/gervasio/covidao/samples/GV"
