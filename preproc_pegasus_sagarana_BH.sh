...
#SBATCH -w naga05.cpu.stats.ox.ac.uk
#SBATCH --output=/vols/opig/users/gervasio/rep_pipe_log.out
#SBATCH --error=/vols/opig/users/gervasio/rep_pipe_oops_did_not_work.out

source /vols/opig/users/gervasio/local/bin/activate

dir="/vols/opig/users/gervasio/covidao/sagarana/BH"
