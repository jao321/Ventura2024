...
#PBS -N SP10
#PBS -e SP10_pre_err.err
#PBS -o SP10_pre_log.log
#PBS -q fila64
#PBS -l select=1:ncpus=8
#PBS -M joaodgervasio@gmail.com


/home/joaodgervasio/miniconda3/bin/python /home/joaodgervasio/2sagarana/local_usr/AssemblePairs.py align -1 /home/joaodgervasio/2sagarana/covid_sample/SP/SP10/R1.fastq -2 /home/joaodgervasio/2sagarana/covid_sample/SP/SP10/R2.fastq --nproc 24 --rc tail --coord illumina --outdir /home/joaodgervasio/2sagarana/covid_sample/SP/SP10 --outname SP10 --minlen 50 --log SP10.log --failed

# dir="/home/joaodgervasio/2sagarana/covid_sample/SP/SP10"
...
# 	/home/joaodgervasio/miniconda3/bin/python /home/joaodgervasio/2sagarana/local_usr/MakeDB.py igblast -s "$pasta"/"${sample[0]}"_primers-pass.fasta -i "$pasta"/"${sample[0]}"_primers-pass_igblast.fmt7 --format airr -r /home/joaodgervasio/2sagarana/imgt/human/vdj --outdir "$pasta" --outname "${sample[0]}" --extended 
